...
$: accountablePersons = $dependentsByPolicyId //TODO add current User to this: = [$dependents..., currentUser]
...
$: $dependentsByPolicyId.length && $user.policy_id && loadDependents($user.policy_id)
