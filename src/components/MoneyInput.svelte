...
<label class="mdc-text-field mdc-text-field--outlined {$$props.class} textfield-radius label-width"
  ...
  <input type="number" min="0" class="mdc-text-field__input NotoSans m-l-24px" aria-labelledby={labelID} bind:value use:focus on:blur {maxlength} {disabled} {placeholder}>
